...
function checkInsuranceEligibility() {
  ...
  if (insurance === "Government") {
    ...
    toggleGovtPriceAvailability();
  } else if (insurance === "Uninsured") {
    displayBlockById("insuranceCheckoutNote");
    // Hide insurance-related elements
    const insuranceTreatment = document.getElementById("insuranceTreatment");
    const insuranceTag = document.getElementById("insuranceTag");
    
    if (insuranceTreatment) insuranceTreatment.style.display = "none";
    if (insuranceTag) insuranceTag.style.display = "none";
  } else if (insurance === "Kaiser") {
    displayBlockById("insuranceCheckoutNote");
  }
  // soft block
  return true;
